...
- [ ] **Phase 37: Advanced Waveform Bus Slicing, Analog Waveform Mode & Precision Frequency Measurement - [P2]**
  ...
  - [ ] **Analog & Stepped Waveform Plotting**:
    - Mode toggle per multi-bit trace rendering values as continuous or stepped analog curves (ideal for PWM, DAC, ADC, and counter ramps).
  - [ ] **Precision Frequency & Period Measurement HUD**:
    - Dual cursor measurement window displaying both $\Delta t$ and reciprocal frequency ($f = 1/\Delta t$ in kHz, MHz, GHz).
    - Draggable timeline bookmark markers with custom annotation tags.
