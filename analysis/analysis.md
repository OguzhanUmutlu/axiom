...
| **`03_elaboration_and_netlist_ir.md`** | **Elaboration & Netlist IR** | • Recursive instantiation and hierarchical scope resolution.<br>• Compile-time parameter evaluation and `generate` expansion.<br>• Port binding and multi-driver resolution.<br>• Specification of Axiom/Axiom Intermediate Representation (BIR). |
