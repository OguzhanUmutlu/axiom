...
export interface Translations {
  ...
  newProjectModal: {
    ...
    browseBtn: string;
    createSubdirLabel: string;
    previewCreatedPrefix: string;
    step2Desc: string;
    recommendedBadge: string;
    rtlTitle: string;
    rtlDesc: string;
    rtlSkipSources: string;
    postSynthTitle: string;
    postSynthDesc: string;
    postSynthSkipSources: string;
    ioPlanningTitle: string;
    ioPlanningDesc: string;
    importedTitle: string;
    importedDesc: string;
    exampleTitle: string;
    exampleDesc: string;
    preconfiguredSystems: string;
    selectCourseworkLesson: string;
    step3PartsTab: string;
    step3BoardsTab: string;
    targetPartLabel: string;
    defaultBadge: string;
    searchPartsPlaceholder: string;
    searchBoardsPlaceholder: string;
    allFamilies: string;
    allSpeeds: string;
    allVendors: string;
    colPartName: string;
    ...
    colDsps: string;
    colIobs: string;
    boardVendorLabel: string;
    boardPartLabel: string;
    step4Desc: string;
    summaryProjectName: string;
    summaryProjectLocation: string;
    summaryProjectType: string;
    summaryInitialSources: string;
    sourceDesignDefault: string;
    sourceCourseworkLesson: string;
    sourceCuratedTemplate: string;
    sourceEmptyFileset: string;
    summaryTargetDevice: string;
    summaryHardwareSpecs: string;
    specsSummaryFormat: string;
    valNameEmpty: string;
    valNameInvalidChars: string;
    valNameDot: string;
    valNameTrashCollision: string;
    valNameCollision: string;
  };
}
